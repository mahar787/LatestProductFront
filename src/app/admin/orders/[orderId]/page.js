      ...
      <div className="flex-col w-screen h-screen items-center">
        ...
        {order && (
          <div className="w-full max-w-2xl  p-6 rounded-lg shadow-lg ">
            ...
            <p>
              <strong>Delivery Charges:</strong> {order?.deliveryCharges} ./Rs
            </p>
            <p>
        ...
        <table className="w-full border-collapse border border-gray-700">
          <thead>
            <tr className="bg-black text-white">
              ...
              <th className="border border-gray-600 p-2">Size</th>
              ...
              order.items.map((item, i) => {
                return (
                  ...
                  >
                    ...
                    <td className="border border-gray-600 p-2">{item?.size}</td>
                    <td className="border border-gray-600 p-2">
                      {item?.color}
                    </td>
                    <td className="border border-gray-600 p-2">
