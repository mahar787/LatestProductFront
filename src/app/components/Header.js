    ...
    <>
      <header className="flex px-6 text-white justify-between items-center bg-black">
        ...
        {showCart && (
          <div
            ref={cartRef}
            className={`w-full sm:w-[80%] md:min-w-[520px] transition-all max-w-[620px] overflow-auto z-10 h-[90vh] absolute top-14 right-0  mx-auto sm:right-2 p-4 rounded-md shadow-lg border bg-white `}
          >
            <section>
                    ...
                    <tbody className={`text-lg`}>
                      {cartItems.map((item, index) => (
                        ...
                        >
                          ...
                          <td
                            className={`px-4 py-2 text-center font-semibold text-[#333333] `}
                          >
